...
export default function RegisterPage() {
  ...
  const [message, formAction, isPending]= useActionState(registerAction, "", {  // "" mean (initial state)empty string,after completing registerAction fn , which store response msg
    withPending : true
  });
  return (
